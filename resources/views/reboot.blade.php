    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                @if(isset($failed))
                  <div class="panel-heading">Failed to reboot server!</div>
                  <div class="panel-body">
                    <hr />
                    <div class="alert alert-danger">
                      Server failed to be rebooted Cannot connect to server.
                    </div>
                ...
                @elseif(isset($success))
                      <div class="panel-heading">Server rebooted successfully!</div>
                      <div class="panel-body">
                        <hr />
                        <div class="alert alert-success">
                          Server has been rebooted successfully! Congratulations.
                        </div>
                        <a href="http://{{ $_SERVER['SERVER_NAME']}}" class="btn btn-default btn-lg" style="margin-left:40%;margin-top:20px;"><span class="glyphicon glyphicon-home"></span> Back to home.</a>
                @endif
                  <div class="col-md-12">
