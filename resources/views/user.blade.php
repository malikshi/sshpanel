        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @if(isset($nousers))
                      <h3 style="text-align:center">NO SSH ACCOUNT FOUND ON SERVER {{$nousers}}</h3>

                    @elseif(isset($users))
                    <h3 style="text-align:center !important;">LIST SSH ACCOUNTS ON SERVER {{$users[0]->on_server}}</h3>
